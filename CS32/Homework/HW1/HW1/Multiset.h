...
class Multiset
	...
	private:
		static const int DEFAULT_MAX_ITEMS=200; //initialize the max size
		ItemType *ptr; int counter;   bool *checker; ItemType inv[DEFAULT_MAX_ITEMS];
	 	 bool check[DEFAULT_MAX_ITEMS];
     };
#endif