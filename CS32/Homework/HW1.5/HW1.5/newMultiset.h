#include <iostream>
using namespace std;
#ifndef newMULTI_INCLUDED
#define newMULTI_INCLUDED
typedef unsigned long ItemType;

class Multiset
    {
      public:
		Multiset(const int& value); // A constructor that initializes the array to hald value unique items
	...
	private:
		static const int DEFAULT_MAX_ITEMS=200; ItemType *ptr; int counter;   bool *checker; 
		int uniq; int length; int uniq_count; //ItemType *rep; bool *repcheck;
					// length of array
